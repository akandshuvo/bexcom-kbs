...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header
    ...
    <header class="mdl-layout__header">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">PROGRAM GUIDE</span>
...
<!--USER NAME AFTER LOGIN-->
        ...
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect">
            <a href="#fixed-tab-1" class="mdl-layout__tab is-active">EPG</a>
            <a href="#fixed-tab-2" class="mdl-layout__tab">NORMAl</a>
        </div>
    </header>
          ...
          <div class="page-content">
              ...
              <div class="mdl-grid">
                  ...
                  <div class="mdl-cell mdl-cell--3-col">
                    <form class="" action="upload/program_guide_upload.php" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="mdl-cell mdl-cell--3-col">
                      <button type="submit" name="epg"  class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored">UPLOAD</button>
                    </div>
                  </form>
              </div>
              <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col">
                  <table class="table table-bordered text-center">
                    ...
                    <?php
                  $sql="SELECT * FROM upload_location WHERE location='../../docs/program_guide/epg/'  ";
                  ...
                  while($row=mysql_fetch_array($result_set))
                  {
                    ?>
                        ...
                        <td>
                          <a href="../docs/program_guide/epg/<?php echo $row['file'] ?>" target="_blank">
          ...
          <div class="page-content">
              ...
              <div class="mdl-grid">
                  ...
                  <div class="mdl-cell mdl-cell--3-col">
                    ...
                    <div class="mdl-cell mdl-cell--3-col">
                      <button type="submit" name="normal"  class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored">UPLOAD</button>
                    </div>
                  </form>
              </div>
              <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col">
                  <table class="table table-bordered text-center">
                    ...
                    <?php
                  $sql="SELECT * FROM upload_location WHERE location='../../docs/program_guide/normal/'  ";
                  $result_set=mysql_query($sql);
                  while($row=mysql_fetch_array($result_set))
                  {
                    ?>
                        ...
                        <td><?php echo $row['size'] ?></td>
                        <td>
                          <a href="../docs/program_guide/normal/<?php echo $row['file'] ?>" target="_blank">
                            <button   class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored">VIEW</button>
                          </a>
                        </td>
                        <td>
