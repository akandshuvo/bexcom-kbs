...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2016 at 05:31 PM
...
INSERT INTO `archive` (`id`, `file`, `type`, `size`, `location`, `date`) VALUES
(0, '[kat.cr]blindspot.s01e21.hdtv.x264.lol.ettv.torrent-65347', 'application/x-bittorrent', '3.103515625', '../../docs/dth/product/', '2016-05-10 21:31:31');
...
INSERT INTO `upload_location` (`id`, `file`, `type`, `size`, `location`, `date`) VALUES
(57, '[kat.cr]blindspot.s01e21.hdtv.x264.lol.ettv.torrent-65347', 'application/x-bittorrent', '3.103515625', '../../docs/dth/product/', '2016-05-10 21:31:31');
