...
/*Retailer Location*/
if(isset($_POST['installer_address']))
{
  ...
  $folder="../../docs/installer_address/";
  $root="installer_address";
  $sub_root="installer_address";
  ...
  if(move_uploaded_file($file_loc,$folder.$final_file))
  {
    ...
    alert('successfully uploaded');
        window.location.href='../installer_address.php';
        </script>
    <?php
  }
  else
