...
if(isset($_POST['cross_sales']))
{
  ...
  $file_size = $_FILES['file']['size'];
  $file_type = $_FILES['file']['type'];
  $folder="../../docs/script/cross_sales/";
