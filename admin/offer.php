...
<!--USER NAME AFTER LOGIN-->
        ...
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect">
            <a href="#fixed-tab-1" class="mdl-layout__tab is-active">new customer</a>
            <a href="#fixed-tab-2" class="mdl-layout__tab">old customer</a>
        </div>
    </header>
          ...
          <div class="page-content">
              ...
              <div class="mdl-grid">
                  ...
                  <div class="mdl-cell mdl-cell--3-col">
                    ...
                    <div class="mdl-cell mdl-cell--3-col">
                      <button type="submit" name="new_customer"  class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored">UPLOAD</button>
                    </div>
                  </form>
              </div>
              <div class="mdl-grid">
