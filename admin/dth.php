                ...
                <div class="mdl-grid">
                    ...
                    <div class="mdl-cell mdl-cell--2-col">
                        <form action="upload.php" method="post" enctype="multipart/form-data" name="dthservice" id="dthservice">
                            <label for="FileUpload"></label>
                            <input type="file" name="dthservice" id="dthservice" />
                            <input type="submit" name="Upload" id="Upload" value="Upload" />
                        </form>
                    </div>
                </div>
        ...
        <section class="mdl-layout__tab-panel" id="fixed-tab-3">
            <div class="page-content">
                ...
                <div class="mdl-grid">
                    ...
                    <div class="mdl-cell mdl-cell--2-col">
                        <form action="upload.php" method="post" enctype="multipart/form-data" name="dth_offer" id="dth_offer">
                            <label for="FileUpload"></label>
                            <input type="file" name="dth_offer" id="dth_offer" />
                            <input type="submit" name="Upload" id="Upload" value="Upload" />
                        </form>
                    </div>
                </div>
        ...
        <section class="mdl-layout__tab-panel" id="fixed-tab-4">
            <div class="page-content">
                ...
                <div class="mdl-grid">
                    ...
                    <div class="mdl-cell mdl-cell--2-col">
                        <form action="upload.php" method="post" enctype="multipart/form-data" name="dth_whyrealvu" id="dth_whyrealvu">
                            <label for="FileUpload"></label>
                            <input type="file" name="dth_whyrealvu" id="dth_whyrealvu" />
                            <input type="submit" name="Upload" id="Upload" value="Upload" />
                        </form>
                    </div>
                </div>
