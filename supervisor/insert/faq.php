...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header
    ...
    <header class="mdl-layout__header">
        ...
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect">
            <a href="#fixed-tab-1" class="mdl-layout__tab is-active">Frequently Asked Question</a>
        </div>
    </header>
            ...
            <div class="page-content">
                ...
                <div class="mdl-grid">
                    ...
                    <div class="mdl-cell mdl-cell--5-col">
                        <form id="after_sale_insert" method="post" action="faq_insert.php">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" type="text" id="question" name="question">
                                <label class="mdl-textfield__label" for="question">QUESTION</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield">
                              <textarea class="mdl-textfield__input" type="text" rows= "3" name="answer" id="sample5" ></textarea>
                              <label class="mdl-textfield__label" for="sample5">ANSWER</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">

                              <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="flash1">
                              <input checked class="mdl-radio__button" id="flash1" name="category" type="radio"
                               value="new">
                              <span class="mdl-radio__label">New Real VU Connection</span>
                              </label>

                              <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="flash2">
                                <input class="mdl-radio__button" id="flash2" name="category" type="radio" value="pack">
                                <span class="mdl-radio__label">Pack</span>
                              </label>

                              <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="flash3">
                                <input class="mdl-radio__button" id="flash3" name="category" type="radio" value="recharge">
                                <span class="mdl-radio__label">Recharge Service</span>
                              </label>

                              <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="flash4">
                                <input class="mdl-radio__button" id="flash4" name="category" type="radio" value="hardware">
                                <span class="mdl-radio__label">Set Top Box and Hardware</span>
                              </label>
                            </div>
