...
<!--USER NAME AFTER LOGIN-->
        ...
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect">
            <a href="#fixed-tab-1" class="mdl-layout__tab is-active">SOCIAL MEDIA</a>
        </div>
    </header>
          ...
          <div class="page-content">
              ...
              <div class="mdl-grid">
                  ...
                  <div class="mdl-cell mdl-cell--3-col">
                    <form class="" action="upload/social_media_upload.php" method="post"  enctype="multipart/form-data">
              ...
              <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col">
                  <table class="table table-bordered text-center">
                    ...
                    <?php
                  $sql="SELECT * FROM upload_location WHERE location='../../docs/social_media/'  ";
                  ...
                  while($row=mysql_fetch_array($result_set))
                  {
                    ?>
                        ...
                        <td>
                          <a href="../docs/social_media/<?php echo $row['file'] ?>" target="_blank">
